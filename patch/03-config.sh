...
if [ -d "${LIBRENMS_PATH}/html/plugins/Weathermap" ]; then
  ...
  find /data/weathermap ${LIBRENMS_PATH}/html/plugins/Weathermap/output -not -user librenms -o -not -group librenms -print0 | xargs -0 -r chown librenms:librenms
...
find /data/logs ${LIBRENMS_PATH}/composer* ${LIBRENMS_PATH}/config.d ${LIBRENMS_PATH}/bootstrap ${LIBRENMS_PATH}/logs ${LIBRENMS_PATH}/storage ${LIBRENMS_PATH}/vendor -not -user librenms -o -not -group librenms -print0 | xargs -0 -r chown librenms:librenms
